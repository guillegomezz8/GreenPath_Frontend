  ...
  return (
    <input
      ...
      className={cn(
        ...
        isDateInput && 'block h-11 min-h-11 appearance-none overflow-hidden pr-10 text-left [color-scheme:light] [-webkit-appearance:none] [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-90 [&::-webkit-date-and-time-value]:block [&::-webkit-date-and-time-value]:w-full [&::-webkit-date-and-time-value]:min-h-[1.5rem] [&::-webkit-date-and-time-value]:min-w-0 [&::-webkit-date-and-time-value]:overflow-hidden [&::-webkit-date-and-time-value]:text-left [&::-webkit-date-and-time-value]:text-ellipsis [&::-webkit-datetime-edit]:flex [&::-webkit-datetime-edit]:w-full [&::-webkit-datetime-edit]:min-w-0 [&::-webkit-datetime-edit]:items-center [&::-webkit-datetime-edit-fields-wrapper]:flex [&::-webkit-datetime-edit-fields-wrapper]:w-full [&::-webkit-datetime-edit-fields-wrapper]:min-w-0',
        className
      )}
      ref={ref}
      {...props}
